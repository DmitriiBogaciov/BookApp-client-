Наша задача сделать сортируемое дерево со страницами для книг. Каждая страница может иметь подстраницы, и мы хотим позволить пользователям перетаскивать страницы, чтобы изменить их порядок и иерархию.    
